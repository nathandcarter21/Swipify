...
struct AboutView: View {
    var body: some View {
        VStack(spacing: 50) {
            Text("Welcome to Swipify, the ultimate music companion that revolutionizes your music discovery experience. By seamlessly integrating with your Spotify account, Swipify fetches recommended songs based on your favorite tracks, providing you with a personalized playlist like no other.")
                .multilineTextAlignment(.center)
            Text("With Swipify, exploring new music that resonates with your taste has never been easier. You can preview these recommended songs within the app and swipe right for the ones you like or left for the ones that don't resonate with you. Plus, you can effortlessly add songs to your liked songs collection or create custom playlists for any occasion, putting you in complete control of your music library.")
                .multilineTextAlignment(.center)
        }
        .padding(40)
